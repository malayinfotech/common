...
func init() {
	if percent, err := strconv.Atoi(os.Getenv("STORX_QUIC_ROLLOUT_PERCENT")); err == nil {
...
func checkQUICRolloutState(ctx context.Context, id storx.NodeID) bool {
...
func setQUICRollout(ctx context.Context, nodeURL storx.NodeURL) context.Context {
...
var quicRolloutSatelliteIDs = map[storx.NodeID]bool{
