...
var (
	...
	IdentityVersions = VersionedIdentitiesMap{
		storx.V0: pregeneratedV0Identities,
	}

	// SignedIdentityVersions holds pregenerated, signed identities for each
	// identity version.
	SignedIdentityVersions = VersionedIdentitiesMap{
		storx.V0: pregeneratedV0SignedIdentities,
	}

	// SignerVersions holds certificate authorities for each identity version.
	SignerVersions = VersionedCertificateAuthorityMap{
		storx.V0: pregeneratedV0Signer,
	}
)

// VersionedIdentitiesMap maps a `storx.IDVersionNumber` to a set of
// pregenerated identities with the corresponding version.
type VersionedIdentitiesMap map[storx.IDVersionNumber]*Identities

// VersionedCertificateAuthorityMap maps a `storx.IDVersionNumber` to a set of
// pregenerated certificate authorities used for signing the corresponding
// version of signed identities.
type VersionedCertificateAuthorityMap map[storx.IDVersionNumber]*identity.FullCertificateAuthority
...
func MustPregeneratedIdentity(index int, version storx.IDVersion) *identity.FullIdentity {
...
func MustPregeneratedSignedIdentity(index int, version storx.IDVersion) *identity.FullIdentity {
...
func PregeneratedIdentity(index int, version storx.IDVersion) (*identity.FullIdentity, error) {
...
func PregeneratedSignedIdentity(index int, version storx.IDVersion) (*identity.FullIdentity, error) {
...
func NewPregeneratedIdentities(version storx.IDVersion) *Identities {
...
func NewPregeneratedSignedIdentities(version storx.IDVersion) *Identities {
...
func NewPregeneratedSigner(version storx.IDVersion) *identity.FullCertificateAuthority {
