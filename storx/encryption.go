...
// CipherSuite specifies one of the encryption suites supported by Storx
...
// NewKey creates a new Storx key from humanReadableKey.
func NewKey(humanReadableKey []byte) (*Key, error) {
	...
	// See https://github.com/storx/storx/pull/1967#discussion_r285544849
