...
var (
	// StorxToken is the currency for the STORX ERC20 token, which powers
	// most payments on the current Storx network.
	StorxToken = New("STORX Token", "STORX", 8)
	...
	// LiveGoats is the currency of live goats, which some Storx network
...
// AsUnpreciseFloat returns the monetary value in currency units expressed as a
...
// AsUnpreciseBigFloat returns the monetary value in currency units expressed as an
